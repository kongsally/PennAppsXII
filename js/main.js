...
function init() {
  ...
  for (var i = 0; i < sphere.geometry.vertices.length; i+=constant) {
      ...
      original_positions.push(sphere.geometry.vertices[i].clone());
  }
...
function animate() {
  ...
  var tempVec = new THREE.Vector3(temp, temp, temp);


  //with scalars
  // vertices_of_sphere[0].multiplyScalar(temp);
  // vertices_of_sphere[1].multiplyScalar(temp);
  // vertices_of_sphere[2].multiplyScalar(temp);
  // vertices_of_sphere[3].multiplyScalar(temp);
  // vertices_of_sphere[4].multiplyScalar(temp);
  // vertices_of_sphere[5].multiplyScalar(temp);
  // vertices_of_sphere[6].multiplyScalar(temp);
  // vertices_of_sphere[7].multiplyScalar(temp);
  ...
  //add vectors
  // vertices_of_sphere[0].add(tempVec);
  // vertices_of_sphere[1].add(tempVec);
  // vertices_of_sphere[2].add(tempVec);
  // vertices_of_sphere[3].add(tempVec);
  // vertices_of_sphere[4].add(tempVec);
  // vertices_of_sphere[5].add(tempVec);
  // vertices_of_sphere[6].add(tempVec);
  // vertices_of_sphere[7].add(tempVec);
